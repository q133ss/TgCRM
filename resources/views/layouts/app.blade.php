                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0);" data-theme="light">
                                        <span class="align-middle"><i class="ri-sun-line ri-22px me-3"></i>Светлая</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0);" data-theme="dark">
                                        <span class="align-middle"><i class="ri-moon-clear-line ri-22px me-3"></i>Темная</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0);" data-theme="system">
                                        <span class="align-middle"><i class="ri-computer-line ri-22px me-3"></i>Системная</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
...
{{--                        </li>--}}
                        ...
                        @php
                            if(isset(request()->uid)){
                                $user = \App\Models\User::where('telegram_id', request()->uid)->firstOrFail();
                            }else{
                                if(!auth()->check()){
                                    abort(401);
                                }
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                <div class="avatar avatar-online">
                                    <span class="avatar-initial rounded-circle bg-primary">{{substr($user->first_name, 0, 1)}}</span>
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <i class="ri-user-3-line ri-22px me-3"></i><span class="align-middle">Профиль</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <i class="ri-settings-4-line ri-22px me-3"></i><span class="align-middle">Настройки</span>
                                    </a>
                                </li>
                                <li>
                                    <div class="dropdown-divider"></div>
                                ...
                                <li>
                                    <a class="dropdown-item" href="#">
                                        ...
                                        ><span class="align-middle">Подписка</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{route('dashboard.faq')}}">
